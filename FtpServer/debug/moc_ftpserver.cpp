...
#include <memory>
#include "../../../ftpServer_qt/FtpServer/ftpServer/ftpserver.h"
...
QT_MOC_LITERAL(1, 10, 9), // "newPeerIp"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 2), // "ip"
QT_MOC_LITERAL(4, 24, 25) // "startNewControlConnection"

    },
    "FtpServer\0newPeerIp\0\0ip\0"
    "startNewControlConnection"
};
...
void FtpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newPeerIp((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->startNewControlConnection(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpServer::newPeerIp)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FtpServer::newPeerIp(const QString & _t1)
{
