...
QList<DynamicData> createDynamicData()
{
    ...
    QString game_cover=":/res/";
    QString dynamic_cover=":/res/dynamic/";
...
void WBGWIdget::initFTPSender()
{
    QUrl url;

    url.setHost("192.168.1.105");
    url.setPort(2121);
    ...
    sender.setLocalPath(saveMatPath);
    sender.startUploading();
}
