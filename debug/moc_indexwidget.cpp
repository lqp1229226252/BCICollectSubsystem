...
QT_MOC_LITERAL(1, 12, 9), // "minSingal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "maxSingal"
QT_MOC_LITERAL(4, 33, 12), // "tabClickSlot"
QT_MOC_LITERAL(5, 46, 5), // "index"
QT_MOC_LITERAL(6, 52, 14), // "on_min_clicked"
QT_MOC_LITERAL(7, 67, 14), // "on_max_clicked"
QT_MOC_LITERAL(8, 82, 16) // "on_close_clicked"

    },
    "IndexWidget\0minSingal\0\0maxSingal\0"
    "tabClickSlot\0index\0on_min_clicked\0"
    "on_max_clicked\0on_close_clicked"
};
...
void IndexWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->minSingal(); break;
        case 1: _t->maxSingal(); break;
        case 2: _t->tabClickSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->on_min_clicked(); break;
        case 4: _t->on_max_clicked(); break;
        ...
        {
            using _t = void (IndexWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IndexWidget::minSingal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (IndexWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IndexWidget::maxSingal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void IndexWidget::minSingal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void IndexWidget::maxSingal()
{
